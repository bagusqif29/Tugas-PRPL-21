...
<div id="container">
	<div id="box">
		...
		<form method="post">
			...
			<input id="text" type="email" name="username" required ><br><br>
			<input id="text" type="password" name="password" pattern="(?=.*\d)(?=.*[a-zA-Z]).{6,}" required title="Must contain at least one number and letter at least 6 Characters or more"><br><br>
